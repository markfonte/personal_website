...
const links = [
  {
    name: "Gimble A Cappella on Spotify",
    image: spotifyLogo,
    link: spotifyLink,
  },
  {
    name: "Gimble A Cappella on Apple Music",
    image: appleMusicLogo,
    link: appleMusicLink,
  },
  {
    name: "Gimble A Cappella on YouTube",
    image: youtubeLogo,
    link: youtubeLink,
  },
  ...
  return (
    <Card raised className="large-card">
      ...
      <CardActions sx={{ justifyContent: "flex-end", overflowX: "auto" }}>
        {links.map((link) => (
          <Tooltip title={"go to " + link.name} key={link.name} arrow>
        ...
        <Tooltip title="see website" arrow>
          <IconButton
