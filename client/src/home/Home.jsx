...
const TeslaCard = lazy(() => import("../work/TeslaCard.jsx"));
...
const entrepreneurshipLink =
  "https://innovateblue.umich.edu/academics/minor-in-entrepreneurship/";
...
export default function Home({ isDarkTheme }) {
  ...
  const androidColor = isDarkTheme
    ? "android-color-light"
    : "android-color-dark";
  const fullStackColor = isDarkTheme
  ...
  return (
    <Box sx={styles.root}>
      <Typography sx={styles.title} variant="h6">
        ...
        senior software engineering team lead · ex-
        <Link href={justlightLink} className={justlightColor} underline="hover">
          JustLight
        </Link>{" "}
        software engineering team lead · ex-
      ...
      <Suspense styles={styles.root} fallback={renderLoader()}>
        ...
        >
          ...
          <NewsCard isDarkTheme={isDarkTheme} />
          <TeslaCard />
          <GimbleCard />
          <SammyCard />
