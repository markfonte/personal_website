...
import sammyArticle1 from "../static/photos/sammy_article_1.webp";
import sammyArticle2 from "../static/photos/sammy_article_2.webp";
import sammyArticle3 from "../static/photos/sammy_article_3.webp";
import sammyArticle4 from "../static/photos/sammy_article_4.webp";
import sammyArticle5 from "../static/photos/sammy_article_5.webp";
  ...
  return (
    <Card raised className="large-card">
      ...
      <CardActions sx={{ justifyContent: "flex-end" }}>
        <Tooltip title="see all articles" arrow>
          <IconButton
            aria-label="Go to website"
            href="https://www.michigandaily.com/author/sfonteumich-edu/"
            size="medium"
          >
            <WebIcon />
          </IconButton>
