...
export default function WelcomeCard({ isDarkTheme }) {
  const justlightColor = isDarkTheme
      ...
      <Accordion slotProps={{ transition: { unmountOnExit: true } }}>
        ...
        >
          ...
          <Box sx={styles.expansionHeaderContainer}>
            <CardHeader className="card-header" title="Welcome!" subheader="" />
            <ImageList variant="masonry" cols={2} sx={{ marginBottom: "0px" }}>
              {highlightedPhotoData.map((item, i) => (
        ...
        <AccordionDetails>
          <CardContent sx={styles.cardContent}>
            ...
            <Typography variant="body1" paragraph>
              ...
              <Tooltip arrow title="go to Tesla">
                <Link
                  color="secondary"
                  href={teslaLink}
                  className={teslaColor}
                  underline="hover"
                >
                  Tesla
                </Link>
              </Tooltip>
              , a former software engineering lead at a medical device startup
              called{" "}
              <Tooltip arrow title="go to JustLight">
                <Link
                  color="secondary"
                  href={justlightLink}
                  className={justlightColor}
                  underline="hover"
                >
                  JustLight
                </Link>
              ...
              <Tooltip arrow title="go to Amazon Web Services">
                <Link
                  color="secondary"
                  href={awsLink}
                  className={amazonColor}
                  underline="hover"
                >
                  Amazon Web Services
                </Link>
              </Tooltip>
              , I have bachelor&#39;s of computer science in engineering degree
              with a minor in entrepreneurship from{" "}
              <Tooltip arrow placement="bottom" title="go blue...">
                <Link
                  href={umichLink}
                  className={michiganColor}
                  underline="hover"
                >
            ...
            <Typography variant="body1" paragraph>
              ...
              applications. I built this website to be an interactive sandbox
              where I could break things and have fun. I aim to make it faster,
              more intuitive, and easier to navigate. Hopefully the experience
              is better each time you visit! You can always check what I&#39;m
              working on on my{" "}
              <Tooltip arrow title="see my Trello board">
                <Link
                  color="secondary"
                  href={trelloBoardLink}
                  underline="hover"
                >
                  Trello board
                </Link>
