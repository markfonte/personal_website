...
import clippWireframeScreenshotOne from "../static/screenshots/clipp_wireframe_screenshot_1.webp";

import clippWireframeScreenshotTwo from "../static/screenshots/clipp_wireframe_screenshot_2.webp";

import clippWireframeScreenshotThree from "../static/screenshots/clipp_wireframe_screenshot_3.webp";
        ...
        <AccordionDetails>
          <CardContent>
            <Typography variant="body1" sx={{
              ...
              swipe through items you would be willing to exchange for the item.
              If two people &quot;swipe right&quot; on each other&apos;s items,
              then they can meet up to exchange them without ever spending a
              dime! For example, I could want to get rid of my microwave oven,
              and somebody else could want to get rid of a ticket to the
            ...
            <Typography variant="body1" sx={{
              ...
              application in September 2019, and started beta testing in
              December 2019. The project required full-stack work, from the
              ...
              databases. Each developer contributed to different parts of the
              project at different times, working on any task that was critical
              to development progress. This gave all of us full-stack awareness
              and required teamwork and communication.
            </Typography>
            <img
            ...
            <Typography variant="body1" sx={{
              ...
              have been launching right before winter break began. I believe
              that our issues were due to the fact that the app was still too
              buggy at the time for people to actually want to use it.
              Regardless, our project leaders shut down the project after a
            ...
            <Typography variant="body2" sx={{
              ...
              application working on just Android or just iOS, but not both. For
              those people who have to choose between a
              <Link color="secondary" href={hybridAppLink}>
                {" "}
                hybrid mobile application{" "}
              </Link>
              versus two native applications, my official recommendation is that
              it&apos;s way too early for a hybrid mobile application (like
              React Native) to be a smart choice for almost anyone. If you agree
              or disagree, I would love to discuss this further - please reach
              out!
            </Typography>
