...
import parentPortalScreenshotOne from "../static/screenshots/laz_parent_portal_screenshot_1.webp";
import parentPortalScreenshotTwo from "../static/screenshots/laz_parent_portal_screenshot_2.webp";
import parentPortalScreenshotThree from "../static/screenshots/laz_parent_portal_screenshot_3.webp";

import badgeScreenshot from "../static/screenshots/laz_badge_screenshot.webp";
import {
  Typography,
  Card,
  CardMedia,
        ...
        <AccordionDetails>
          <CardContent>
            <Typography variant="body1">
              ...
              in Summer 2017 and Summer 2018 on two separate projects. Learning
              A-Z is a educational software company for elementary school
              students, and both of my projects were features to serve the
              students. Each summer, outside of the main project I worked on a
              small project with the other interns and presented on a computer
              science-related research topic. I was fortunate enough to have two
              great mentors and had the opportunity work alongside some awesome
              coworkers and fellow interns!
            </Typography>
            ...
            <Typography variant="body1" gutterBottom>
              ...
              website. At the time, the Parent Portal only existed as a web app.{" "}
              <i>
                (fun fact: that was a project started by my brother John several
                years ago)
              </i>
              . My task was to bring that functionality to native mobile. I
              built an{" "}
              <Link color="secondary" href={androidLink}>
                Android
              </Link>{" "}
              app using the same APIs as the web application. I built a separate
              application than the{" "}
              <Link color="secondary" href={androidKidazLink}>
                existing Learning A-Z Android application
              </Link>{" "}
              because I wanted parents to have a streamlined way of viewing
              their children&#39;s activity instead of adding another user
              segment to the existing application. Later, they merged my code
              into the existing Android application, which now has seperate
              ...
              at the time. I found that Kotlin was much easier to write clean
              code with. It supports many{" "}
              ...
              (meaning you can have part-Kotlin, part-Java projects)! I would,
              without question, recommend that any Android developer use Kotlin
              instead of Java for all of their projects.
              <br />
              <br />
              The project was picked up by a full-time developer and is{" "}
              <Link color="secondary" href={androidKidazLink}>
                live in production
              </Link>
              ! The following screenshots are from the production application:
            </Typography>
            <img
            ...
            <Typography variant="body1" gutterBottom>
              ...
              . This is an incentives program for the students in which they
              receive &#34;badges&#34; for achieving goals such as &#34;Read at
              least one book a day for five straight days&#34; or &#34;Complete
              eight 100% quizzes in a row&#34; <br />
              <br />
              This badge program was only an idea at the time that I took it on,
              so much of the work was in planning. I particularly learned a lot
              from the struggle with how to represent the badges in the database
              in a way that minimizes load, and where to hook in the code that
              could tell us when students earned badges while still minimizing
              the number of API calls. I am so thankful that I had great
              engineers around me that could fix and help me learn from my
              numerous mistakes throughout that summer. This project was my
              first formal experience writing server-side code in{" "}
            ...
            <Typography variant="body1">
              <br />
              As a final note, I met some of the best people I have ever known
              during my two summers at Learning A-Z. They are welcoming,
              encouraging, great engineers and just good people. I am very
              thankful for my time there. To anyone looking for a job in Ann
              Arbor, I would certainly recommend Learning A-Z. Feel free to
              contact me and I would be happy to give more details on my
