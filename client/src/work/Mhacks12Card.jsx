...
import instEventsScreenshotOne from "../static/screenshots/instevents_screenshot_1.webp";
import instEventsScreenshotTwo from "../static/screenshots/instevents_screenshot_2.webp";
import instEventsScreenshotThree from "../static/screenshots/instevents_screenshot_3.webp";
import mhacksNathanAndMark from "../static/photos/mhacks_mark_and_nathan.webp";
...
const recyclerViewLink = `https://developer.android.com/reference/kotlin/androidx/recyclerview/widget/RecyclerView`;
        ...
        <AccordionDetails>
          <CardContent>
            <Typography variant="body1" sx={{
              ...
              . The idea for the app came out of{" "}
              <Link color="secondary" href={ala256Link}>
                one of my entrepreneurship classes
              </Link>{" "}
              where we were asked to &quot;explore&quot; something new on campus
              every week. It didn&apos;t matter where we went - concerts,
              festivals, restaurants - as long as it was something we had never
              done before. Thus, I was craving an app that I could open up to
            ...
            <Typography variant="body1" sx={{
              ...
              app that we built features a{" "}
              <Link color="secondary" href={googleMapsLink}>
                Google Maps
              </Link>{" "}
              view that immediately opens to show today&apos;s current and
              upcoming events. In addition, it allows users to browse current
              and upcoming events in a clean{" "}
              ...
              list. Users can add events with an interface that features{" "}
            ...
            <Typography variant="body1" sx={{
              ...
              seamless as possible, instead of using that time to partially
            ...
            <Typography variant="body1" sx={{
              ...
              sorting of events as opposed to the normal <i>
                popularity-based
              </i>{" "}
              sorting of events. In other words, events with only 30 people
              attending get the same weight on the map as those with 5,000. This
              allows for an
              <b>
                <i> even playing field</i>
              </b>{" "}
              and is a concept we have seldom seen before.
            </Typography>
            <img
            ...
            <Typography variant="body1" sx={{
              ...
              not win any awards with it, but there were lots of projects and
              very few awards given out at MHacks 12. We had a great time and
