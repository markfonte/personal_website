...
import miSymptomsScreenshotOne from "../static/screenshots/mi_symptoms_screenshot_1.webp";
import miSymptomsScreenshotTwo from "../static/screenshots/mi_symptoms_screenshot_2.webp";
import miSymptomsScreenshotThree from "../static/screenshots/mi_symptoms_screenshot_3.webp";
        ...
        <AccordionDetails>
          <CardContent>
            <Typography variant="body1" sx={{
              ...
              to track the spread of the coronavirus and give residents
              resources they need to fight it. Residents can take a survey each
              day through the application which asks about current symptoms,
              current temperature, test results and more. Users who are
              determined &#34;at-risk&#34; based on their symptoms are given the
              resources they need and can even be contacted directly by health
              professionals. No sensitive user data is stored by the application
              (it is sent straight to the State of Michigan).
              <br /> <br />
              It is backed by the highest levels of the Michigan government and
              is being developed by about 30 University of Michigan computer
              science juniors and seniors, along with a few professors,
              ...
              . At the time of writing (May 20th, 2020), it is being tested in
              production with larger and larger groups of people.
            </Typography>
            <img
            ...
            <Typography variant="body1" sx={{
              ...
              challenge of only being able to communicate remotely. I managed
              building out testing tools to cover different domains like
              ...
              test suite for stress testing. We put in place a process for
              continuously{" "}
              <Link color="secondary" href={smokeTestingLink}>
                smoke testing
              </Link>{" "}
              the application and putting actionable, reproducible issues in
              front of the development team on our{" "}
              <Link color="secondary" href={trelloLink}>
                Trello
              </Link>{" "}
              board. Everything required constant communication with all parts
              of the team to ensure that we were responding as quickly as
              possible to frequent requirements changes. We used tools like{" "}
              ...
              , and facilitated the use of security tools like{" "}
              <Link color="secondary" href={appScanLink}>
                IBM AppScan
              </Link>{" "}
              from the University of Michigan ITS team - anything that would
            ...
            <Typography variant="body1" sx={{
              ...
              of their hearts - simply for the prospect that they might be able
              to help some people. Thank you all!
            </Typography>
