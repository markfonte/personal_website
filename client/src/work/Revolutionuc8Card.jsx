  ...
  return (
    <Card raised className="large-card">
      <Accordion slotProps={{ transition: { unmountOnExit: true } }}>
        ...
        >
          <a
            name="revolutionuc8_card"
            href="#revolutionuc8_card"
            className="gone"
          >
            RevolutionUC 8 Card
          </a>
        ...
        <AccordionDetails>
          <CardContent>
            <Typography variant="body1" paragraph>
              ...
              server such that if anyone called (614) 782-8989 we could prank
              them a little bit. The idea was that you could give someone this
              fake phone number if you didn&apos;t want to give them your real
              phone number. Then we would connect two people who were given that
