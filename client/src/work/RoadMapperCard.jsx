...
import roadMapperScreenshotOne from "../static/screenshots/ice_road_mappers_screenshot_1.webp";
        ...
        <AccordionDetails>
          <CardContent>
            <Typography variant="body1" gutterBottom>
              ...
              during my final semester in college. It was really fun because I
              got to use{" "}
              <Link color="secondary" href={vueLink}>
                Vue.js
              </Link>{" "}
              for the first time on an actual web application. It was very
              simple to use, and I loved how lightweight it was (with a single
              import you can start using Vue right away in any web application).
              <br />
              <br />
              ...
              allow users to indicate driving hazards and speed traps that they
              find. We used the same concept to crowdsource the presence of
              (primarily winter) walking hazards like ice, snow and mud. Using
              the{" "}
              <Link color="secondary" href={mapboxApiLink}>
                Mapbox API
              </Link>{" "}
              we had a map that allowed users to create, read, update and delete
              different walking hazards. They could enter a description, drag
              markers to a spot, select the type of hazard, and even use
              built-in walking directions. We stored the currently-active
              hazards in a{" "}
            ...
            <Typography variant="body1" gutterBottom>
              <br />
              Although we never released it to the public, it was a great
              experience with a new framework and a new API. It was also a
              testament to how smoothly a project can be built if the team is on
              the same page, despite being made entirely during quarantine!
            </Typography>
